...
def main():
    ...
    parser.add_argument('--root', '-R', default='/home/cs28/workspace/',
    ...
    train = train_imagenet.PreprocessedDataset(
        args.train, args.root, mean, model2.insize) ##Falseを追加でも固定できる
    val = train_imagenet.PreprocessedDataset(
        args.val, args.root, mean, model2.insize, False)
