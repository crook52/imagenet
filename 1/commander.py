...
parser.add_argument('--rootdir', '--r', default='/home/cs28/PycharmProjects/ymd/chainer-master2')
parser.add_argument('--o', default='test1')
parser.add_argument('--cuDNN', default=False)
parser.add_argument('--maxEpoch', default=3 ,type=int)
